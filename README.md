...
# Problema
Aversão a aplicativos financeiros tradicionais que são burocráticos e geram estresse.

# Persona e Público
Bruna Batista Silva, Analista de Sucesso do Cliente, buscando uma interface intuitiva para iniciantes na organização financeira.

# Funcionalidades-Chave
1. Registro de despesas via chat (Linguagem Natural).
2. Dashboard Zen: Visualização limpa com cores suaves (verde sálvia e grafite).
3. IA Mentor: Campo de "Conselho do Dia" baseado no comportamento de gastos.
4. Metas de Paz: Acompanhamento de objetivos de médio prazo.
